...
const docTemplate = `{
    ...
    "paths": {
        "/admin/amenities": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "CreateAmenityRequest",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/venue-service_internal_dto.CreateAmenityRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/amenities/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "UpdateAmenityRequest",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/venue-service_internal_dto.UpdateAmenityRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/venues": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Status filter: pending / approved / blocked",
                        "name": "status",
                        "in": "query"
                    }
                ],
        ...
        "/spaces/search": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Space type (private_office, meeting_room, desk)",
                        "name": "type",
                        "in": "query"
                    },
                    {
        ...
        "/spaces/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "UpdateSpaceRequest",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/venue-service_internal_dto.UpdateSpaceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/spaces/{id}/manager": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "UpdateManagerRequest",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/venue-service_internal_dto.UpdateManagerRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/venues": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "CreateVenueRequest",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/venue-service_internal_dto.CreateVenueRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/venues/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "UpdateVenueRequest",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/venue-service_internal_dto.UpdateVenueRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/venues/{id}/amenities": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "AddAmenityRequest",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/venue-service_internal_dto.AddAmenityRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/venues/{id}/amenities/{venueAmenityId}": {
            "delete": {
        ...
        "/venues/{id}/spaces": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "CreateSpaceRequest",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/venue-service_internal_dto.CreateSpaceRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "venue-service_internal_dto.AddAmenityRequest": {
            "type": "object",
            "required": [
                "amenity_id"
            ],
        ...
        "venue-service_internal_dto.CreateAmenityRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "venue-service_internal_dto.CreateSpaceRequest": {
            "type": "object",
            "required": [
                "capacity",
                "close_hour",
        ...
        "venue-service_internal_dto.CreateVenueRequest": {
            "type": "object",
            "required": [
                "address",
                "name"
        ...
        "venue-service_internal_dto.UpdateAmenityRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string",
        ...
        "venue-service_internal_dto.UpdateManagerRequest": {
            "type": "object",
            "required": [
                "manager_id"
            ],
        ...
        "venue-service_internal_dto.UpdateSpaceRequest": {
            "type": "object",
            "properties": {
                "capacity": {
                    "type": "integer",
        ...
        "venue-service_internal_dto.UpdateVenueRequest": {
            "type": "object",
            "required": [
                "address",
                "name"
